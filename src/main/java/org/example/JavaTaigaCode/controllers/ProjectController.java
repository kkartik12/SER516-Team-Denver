...
public class ProjectController {
    ...
    @GetMapping("/leadTime/{milestoneID}")
    @ResponseBody
    public List<UserStoryDTO> getLeadTime(@PathVariable("milestoneID") Integer  milestoneID) {
        return Tasks.calculateLeadTime(milestoneID);
    }
}
