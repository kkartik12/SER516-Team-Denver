...
public class BurndownChart {
    ...
    public MilestoneDTO calculateTotalRunningSum(Integer milestoneID, String token) {
    ...
    public MilestoneDTO calculatePartialRunningSum(Integer milestoneID, String token) {
        String response = "";
        try {
            String endpoint = TAIGA_API_ENDPOINT + "/milestones/" + milestoneID;
            HttpGet request = new HttpGet(endpoint);
            ...
            if (userStories.isArray()) {
                for (JsonNode us : userStories) {
                    ...
                    List<TaskDTO> tasks = getUserStoryTasks(us.get("id").asInt(), token);
    ...
    public List<TaskDTO> getUserStoryTasks(Integer userStoryID, String token) {
        try{
    ...
    public MilestoneDTO getTotalBusinessValue(Integer milestoneID, String token) {
        try {
            String endpoint = TAIGA_API_ENDPOINT + "/milestones/" + milestoneID;
            HttpClient httpClient = HttpClients.createDefault();
            HttpGet request = new HttpGet(endpoint);
            ...
            if (responseEntity != null) {
                ...
                for (JsonNode userStory : userStoriesNode) {
                    ...
                    if (isClosed) {
                        ...
                        userStories.add(new UserStoryDTO(userStoryId, getBusinessValueForUserStory(userStoryId, token),
